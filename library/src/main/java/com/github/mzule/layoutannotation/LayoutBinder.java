package com.github.mzule.layoutannotation;
...
public class LayoutBinder {
    ...
    public static View inflate(android.support.v4.app.Fragment fragment, ViewGroup container, boolean attachToRoot) {
        return inflate(fragment.getActivity(), fragment, container, attachToRoot);
    }
    ...
    public static View inflate(Context context, Object source, ViewGroup container, boolean attachToRoot) {
